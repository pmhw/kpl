        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="https://wpa.qq.com/msgrd?v=3&uin=32579135&Site=pay&Menu=yes" target="_blank"><i class="layui-icon layui-icon-login-qq" style="font-size: 19px;"></i> 联系作者</a>\n' +
                    '<a class="more-menu-item" href="https://gitee.com/pmhw" target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> 开源地址</a>\n' +
                    '<a class="more-menu-item" href="www.webpmh.com" target="_blank"><i class="layui-icon layui-icon-theme"></i> 官方网站</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
